...
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/cylynx/motif.gl/issues/new/choose); it's that easy!

## Pull Request Process

1. Ensure any install or build dependencies are removed before the end of the layer when doing a build.
2. Update the README.md with details of changes to the interface, this includes new environment variables, exposed ports, useful file locations and container parameters.
3. Ensure that all the test cases pass. If a new feature or bug fix is proposed for the main `@cylynx/motif` package, we would appreciate it if it comes with a test.
