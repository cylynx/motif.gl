...
export const histogramBins: number = 30;
export const enlargedHistogramBins: number = 100;
 ...
 */
export const getQuantileDomain = (data: any[], valueAccessor?: Accessor, sortFunc?: Sort): number[] => {
  const values =
 ...
 */
export const getOrdinalDomain = (data: any[], valueAccessor?: Accessor): string[] => {
  const values =
    typeof valueAccessor === 'function' ? data.map(valueAccessor) : data;
 ...
 */
export const getLinearDomain = (data: any[], valueAccessor?: Accessor) : [number, number] => {
  const range =
 ...
 * @returns {[number, number]} domain of data
 */
export const getLogDomain = (data: any[], valueAccessor?: Accessor) : [number, number] => {
 ...
 */
export const getTimestampFieldDomain = (data: any[], valueAccessor?: Accessor) : TimeRangeFieldDomain => {
 ...
 */
export const histogramConstruct = (domain: [number, number], values: (Millisecond | null | number)[], bins: number) : HistogramBin[] => {
  return d3Histogram()
 ...
 */
export const getHistogram = (domain: [number, number], values: (Millisecond | null | number)[]): {histogram: HistogramBin[]; enlargedHistogram: HistogramBin[]} => {
  const histogram = histogramConstruct(domain, values, histogramBins);
